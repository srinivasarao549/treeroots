/*!
  ...
  * Build: ender build ../../ender/flywheel ../../ender/clash bean bonzo
  * =============================================================
  */
...
!function () {
  ...
  !function (context, undefined) {
      ...
      clash_inner = function(x, y, h, w, r, v){
          ...
          // Functions test intersection instead of touching. (except for point_point, which would be useless otherwise)
          // This is done to allow for very fast, simple tests to be done.
          check = {
              ...
              point_poly: function(A, B){
                      // implementation of the quandrant algorthim 
                      // http://www.gamasutra.com/view/feature/3429/crashing_into_the_new_year_.php?print=1
                      var verts = B[v],
                      l = verts.length,
                 ...
                 for ( var i = 0, j = l - 1; i < l; j = i++ ){
                      ...
                      // check if any lines are crossed, and increment or decrement the the counter depending on direction
                      if ( (A[x] < v_i[x]) != (A[x] < v_j[x]) ){
                          
                      } else if ( (A[y] < v_i[y]) != (A[y] < v_j[y]) ) {                         
                      
                      }
                  }
                  
                  return (Math.abs(clockwise_crossings) == 4)
